# hmm_sequence.py
# Uses a hidden markov model as returned by hmm_model_build.py (saved in model.dat as binary) which is a list 
# in the form A_count, B_count, T_count and returns the log probability of a given tagged test set.
